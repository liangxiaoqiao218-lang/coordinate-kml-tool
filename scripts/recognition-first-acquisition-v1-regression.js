...
assert.match(serverSource, /const acquisitionEvidence = wgs84UnifiedAcquisitionEvidence/);
assert.match(serverSource, /requestRecognitionAcquisitionEvidenceStore\.getOrBuild\(\{/);
assert.match(serverSource, /candidateCoordinates:\s*acquisitionEvidence\.candidateCoordinates/);
assert.match(serverSource, /candidateCoordinateLines:\s*acquisitionEvidence\.candidateCoordinateLines/);
