...
const shareImageVersion = "20260506wx1";
...
场景分类只能选一个：原矿石 / 矿化岩石 / 河道沉积 / 卫星图 / 老鼠洞 / 已提炼金属 / 金豆/熔炼物 / 其他。
...
改看：熔融边缘、延展感、捶打感、非晶体感、金属密实感、熔炼纹理、表面流动痕、颜色均匀度、夹杂物、气孔、是否像黄铜/铜合金/镀层。
成品金/金豆也要保守：图片只能判断外观特征，不能证明纯度；但不能因为“缺少石英脉”直接判D。
...
快判文案风格：短、狠、像人在现场下判断。不要写论文式长句，不要写百科说明。可参考这些口吻：
...
【结论】
1句话，必须明确判断。控制在20个字以内，像快判口吻，不要写长分析。原矿石偏误判排除；成品金/熔炼物按外观特征判断，不套石英脉/裂隙标准。
...
【潜力评分】
0-100分。它表示“是否值得继续投入时间”。D通常0-34，C通常35-59，B通常60-79，A通常82-96。原矿石若只有金黄色/金属反光/整体发亮且无裂隙、石英脉、局部赋存关系，给10-30分；成品金/熔炼物按熔炼与金属外观证据评分，不因缺少矿石结构扣分；不要固定模板分。

【关键依据】
1.
2.
3.
每条一句，必须符合场景分类。原矿石写误判排除点和结构证据；成品金/熔炼物写熔融边缘、延展感、密实感、纹理或夹杂；不写“需要专业鉴定”。

【主要风险】
1.
2.
每条一句，必须贴合场景。原矿石点出云母/黄铁矿/金属膜/镜面反光/缺少结构关系；成品金/熔炼物点出黄铜/铜合金/镀层/夹杂/无法判断纯度等风险。
